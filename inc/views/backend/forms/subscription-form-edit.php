...
<div class="wrap wpsf-wrap">
    <div class="wpsf-header wpsf-clearfix">
        ...
        <div class="wpsf-add-wrap">
            ...
            <a href="https://wpshuffle.com/contact-us?enquiry_for=wp-subscription-form" target="_blank"><input type="button" class="wpsf-button-orange" value="<?php esc_html_e('Get Support', 'wp-subscription-forms'); ?>"></a>

        </div>
    </div>
    <?php include(WPSF_PATH . '/inc/views/backend/upgrade-banner.php'); ?>
